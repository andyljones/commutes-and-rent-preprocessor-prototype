...
public class InternationalAddressStructure {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "InternationalPostCode", namespace = "http://www.govtalk.gov.uk/people/AddressAndPersonalDetails", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Country", namespace = "http://www.govtalk.gov.uk/people/AddressAndPersonalDetails", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "IntAddressLine", namespace = "http://www.govtalk.gov.uk/people/AddressAndPersonalDetails", type = JAXBElement.class, required = false)
    })
     ...
     * line 75 of file:/D:/Code/transit-and-rents/schema/transxchange-schema/apd/AddressTypes-v1-3.xsd
     * line 72 of file:/D:/Code/transit-and-rents/schema/transxchange-schema/apd/AddressTypes-v1-3.xsd
     * <p>
