...
/**
 * <p>Java class for ServiceVehicleDirectionEnumeration.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ServiceVehicleDirectionEnumeration">
 ...
 * 
 */
@XmlType(name = "ServiceVehicleDirectionEnumeration")
@XmlEnum
public enum ServiceVehicleDirectionEnumeration {
    ...
    ServiceVehicleDirectionEnumeration(String v) {
        value = v;
    }
    ...
    public static ServiceVehicleDirectionEnumeration fromValue(String v) {
        for (ServiceVehicleDirectionEnumeration c: ServiceVehicleDirectionEnumeration.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
