...
/**
 * <p>Java class for InterchangeNodeTypeEnumeration.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="InterchangeNodeTypeEnumeration">
 ...
 * 
 */
@XmlType(name = "InterchangeNodeTypeEnumeration")
@XmlEnum
public enum InterchangeNodeTypeEnumeration {
    ...
    InterchangeNodeTypeEnumeration(String v) {
        value = v;
    }
    ...
    public static InterchangeNodeTypeEnumeration fromValue(String v) {
        for (InterchangeNodeTypeEnumeration c: InterchangeNodeTypeEnumeration.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
