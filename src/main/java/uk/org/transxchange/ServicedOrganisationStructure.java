...
/**
 * An organisation referenced by a bus schedule and for which specific working days and holidays may be defined. A serviced organisation can have child serviced organisations. A child serviced organisation overrides the working days and holidays of its parent. An example parent would be all the schools in a Local Education Authority; this would define the default term days (working days) and holidays for the schools in the area. It might have child schools, in order for individual schools to override the default term days and holidays.
 * 
 * <p>Java class for ServicedOrganisationStructure complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ServicedOrganisationStructure">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="OrganisationCode" type="{http://www.transxchange.org.uk/}ServicedOrganisationCodeType"/>
 *         &lt;element name="Name" type="{http://www.transxchange.org.uk/}NaturalLanguageStringStructure" minOccurs="0"/>
 *         &lt;element name="WorkingDays" type="{http://www.transxchange.org.uk/}DatePatternStructure" minOccurs="0"/>
 *         &lt;element name="Holidays" type="{http://www.transxchange.org.uk/}DatePatternStructure" minOccurs="0"/>
 *         &lt;element name="ParentServicedOrganisationRef" type="{http://www.transxchange.org.uk/}ServicedOrganisationRefStructure" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ServicedOrganisationStructure", propOrder = {
    "organisationCode",
    "name",
    "workingDays",
    "holidays",
...
public class ServicedOrganisationStructure {
    ...
    protected DatePatternStructure workingDays;
    @XmlElement(name = "Holidays")
    protected DatePatternStructure holidays;
    @XmlElement(name = "ParentServicedOrganisationRef")
    protected ServicedOrganisationRefStructure parentServicedOrganisationRef;
     ...
     * @return
     *     possible object is
     *     {@link DatePatternStructure }
     *     
     */
    public DatePatternStructure getWorkingDays() {
        return workingDays;
    }
     ...
     *     
     */
    public void setWorkingDays(DatePatternStructure value) {
     ...
     *     
     */
    public DatePatternStructure getHolidays() {
        return holidays;
    }
     ...
     *     
     */
    public void setHolidays(DatePatternStructure value) {
        this.holidays = value;
    }

    /**
     * Gets the value of the parentServicedOrganisationRef property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public ServicedOrganisationRefStructure getParentServicedOrganisationRef() {
        return parentServicedOrganisationRef;
    }

    /**
     * Sets the value of the parentServicedOrganisationRef property.
     * 
     * @param value
     *     allowed object is
     *     {@link ServicedOrganisationRefStructure }
     *     
     */
    public void setParentServicedOrganisationRef(ServicedOrganisationRefStructure value) {
        this.parentServicedOrganisationRef = value;
    }
